    ...
    return (
        <div className="container mx-auto my-10 p-5">
            <div className="relative bg-white shadow-md rounded p-14 mb-4">
                ...
                <p className={`absolute right-[45%] top-2 text-base badge ${user.status === 'pending' ? 'badge-warning' : user.status === 'active' ? 'badge-accent' : 'badge-error'
                    }`}>{
                        user.status === "pending" ? <>
                ...
                <h2 className="text-2xl text-center font-semibold mb-4">{isEditing ? 'Update' : 'Admin'} Profile</h2>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    {isEditing ? (
                        ...
                        <>
                            ...
                            <p className="text-light-blue-500 text-lg">*{user.role}</p>
                        </>
                    )}
                </div>
                <div className="mb-4">
